...
var Player = {
	keys: {
		...
		multiway: {UP_ARROW: -90, DOWN_ARROW: 90, RIGHT_ARROW: 0, LEFT_ARROW: 180}
	}
};
...
var assetsObj = {
	'images': [
		...
		'assets/images/door/down-arrow.png',	
		'assets/images/door/left-arrow.png',	
		'assets/images/door/right-arrow.png',	
		'assets/images/door/up-arrow.png',	
		'assets/images/enemy/enemy.gif',
		'assets/images/player/player-left.png',
		'assets/images/player/player-right.png',
	],
	'audio': {
			...
			if(!loadError){
				...
				Crafty.e('Delay').delay(function(){
					...
					var play = function(){
						...
						// static layer for showing information
						// example : player score
						Crafty.createLayer('HUD', 'DOM', {scaleResponse: 1, xResponse: 0, yResponse: 0, z: 100});
